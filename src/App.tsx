...
const PROJECTS = [
  {id:'hood',cat:'product',subcat:'appliance',title:'油煙機設計',short:'薄化歐化油煙機、近吸油煙機系列',desc:'為 SAKURA 品牌設計薄化歐化油煙機（2020）及近吸油煙機（2022）、歐化油煙機（2021）系列。涵蓋外觀造型、CMF 規格、結構工程圖及量產驗證，兼顧空氣動力學效能與現代廚房美學。',tags:['產品設計','廚房家電','SAKURA'], images: ['/assets_img/images/hood_euro01.jpg', '/assets_img/images/hood_euro02.jpg', '/assets_img/images/hood_side_suction.jpg']},
  {id:'gas',cat:'product',subcat:'appliance',title:'瓦斯爐設計',short:'嵌入式瓦斯爐工業設計',desc:'嵌入式瓦斯爐工業設計，強調人因操作介面與安全結構整合，完成旋鈕、爐架與玻璃面板之 CMF 規格輸出。',tags:['產品設計','家電'], images: ['/assets_img/images/stove_easy_clean.jpg']},
  {id:'wearable',cat:'product',subcat:'medical',title:'穿戴式裝置設計',short:'睡眠監測智慧手環',desc:'睡眠監測智慧手環設計，整合感測模組與舒適穿戴結構，完成 CMF 規格及爆炸圖輸出。',tags:['穿戴裝置','醫療'], images: ['/assets_img/images/wearable01.jpg', '/assets_img/images/wearable02.jpg', '/assets_img/images/wearable03.jpg', '/assets_img/images/wearable04.jpg']},
  {id:'medical',cat:'product',subcat:'medical',title:'醫療器材設計',short:'低頻治療儀 / 霧化器 / SPO2 手環',desc:'包含低周波治療器 2 款外觀提案、兒童用霧化器外觀提案及 SPO2 手環 5 款外觀提案，完成外觀造型、爆炸圖與量產工程規格文件。',tags:['醫療器材','工業設計'], images: ['/assets_img/images/medical02.jpg']},
  {id:'toy',cat:'product',subcat:'toy',title:'玩具設計',short:'兒童益智玩具系列',desc:'兒童益智玩具系列設計，包含角色造型、結構拼組與安全材質規劃。',tags:['玩具設計','CMF'], images: ['/assets_img/images/toy_design.jpg']},
  {id:'sketch',cat:'product',subcat:'sketch',title:'手繪作品',short:'人物速寫 / 產品草圖 / 概念插畫',desc:'人物速寫、產品草圖與概念插畫，展現設計思維與手感表達能力。',tags:['手繪','插畫'], images: ['/assets_img/images/sketch.jpg']},
  {id:'tws_card',cat:'packaging',subcat:'ce',title:'TWS 紙卡內襯設計',short:'TWS 耳機紙卡內襯方案總覽',desc:'針對 TWS 耳機系列開發紙卡內襯，彙整多種結構選項，形成模組化設計資料庫。',tags:['包裝設計','TWS','紙卡'], images: ['/assets_img/images/tws_card_inner01.png', '/assets_img/images/tws_card_inner02.png', '/assets_img/images/tws_card_inner03.png', '/assets_img/images/tws_card_inner04.png', '/assets_img/images/tws_card_inner05.png', '/assets_img/images/tws_card_inner06.png', '/assets_img/images/tws_card_inner07.png', '/assets_img/images/tws_card_inner08.png', '/assets_img/images/tws_card_inner09.png', '/assets_img/images/tws_card_inner10.png', '/assets_img/images/tws_card_inner11.png', '/assets_img/images/tws_card_inner12.png']},
  {id:'tws_pkg',cat:'packaging',subcat:'ce',title:'TWS 包裝設計',short:'TWS 耳機完整包裝設計',desc:'為國際品牌 TWS 耳機設計完整包材，包含外箱、內裝結構與印刷規格。',tags:['包裝設計','消費電子'], images: ['/assets_img/images/tws_package_design01.jpg', '/assets_img/images/tws_package_design02.jpg']},
  {id:'hdt_card',cat:'packaging',subcat:'ce',title:'HDT 紙卡內襯設計',short:'電競耳機包裝結構方案',desc:'HDT 電競耳機紙卡內襯設計，提出多選項比較方案，支援 RFQ 提案決策。',tags:['包裝設計','HDT'], images: ['/assets_img/images/hdt_card01.jpg', '/assets_img/images/hdt_card02.jpg', '/assets_img/images/hdt_card03.jpg', '/assets_img/images/hdt_card04.jpg', '/assets_img/images/hdt_card05.jpg', '/assets_img/images/hdt_card06.jpg', '/assets_img/images/hdt_card07.jpg', '/assets_img/images/hdt_card08.jpg', '/assets_img/images/hdt_card09.jpg', '/assets_img/images/hdt_card10.jpg', '/assets_img/images/hdt_card11.jpg', '/assets_img/images/hdt_card12.jpg', '/assets_img/images/hdt_card13.jpg', '/assets_img/images/hdt_card14.jpg']},
  {id:'soundbar_card',cat:'packaging',subcat:'ce',title:'Soundbar 紙卡內襯設計',short:'Soundbar 包裝內構設計',desc:'Soundbar 紙卡內襯結構設計，考量產品尺寸與跌落保護需求。',tags:['包裝設計','Soundbar'], images: ['/assets_img/images/soundbar_card_inner01.png', '/assets_img/images/soundbar_card_inner02.png', '/assets_img/images/soundbar_card_inner03.png', '/assets_img/images/soundbar_card_inner04.jpg', '/assets_img/images/soundbar_card_inner05.jpg', '/assets_img/images/soundbar_card_inner06.jpg', '/assets_img/images/soundbar_card_inner07.jpg', '/assets_img/images/soundbar_card_inner08.jpg']},
  {id:'soundbar_pkg',cat:'packaging',subcat:'ce',title:'Soundbar 設計',short:'Soundbar 整體包裝方案',desc:'Speaker Packaging Design，採用 Harvest Foam Dry-Pressed Pulp Tray，整合環保材質與品牌呈現。',tags:['包裝設計','永續','Soundbar'], images: ['/assets_img/images/soundbar_design01.jpg']},
  {id:'webcam',cat:'packaging',subcat:'ce',title:'視訊鏡頭包裝設計',short:'Webcam Packaging Design',desc:'視訊鏡頭包裝設計，採 Black Wet-Pressed Pulp Tray，兼顧防護與環保需求。',tags:['包裝設計','紙托'], images: ['/assets_img/images/webcam01.jpg', '/assets_img/images/webcam02.jpg']},
  {id:'carrycase',cat:'packaging',subcat:'bike',title:'Carrycase 包袋設計',short:'收納包袋結構設計',desc:'自行車零件收納包袋設計，考量多 SKU 共用與模組化包裝平台。',tags:['包裝設計','自行車'], images: ['/assets_img/images/carrycase01.jpg']},
  {id:'mtb',cat:'packaging',subcat:'bike',title:'MTB Handle Bar 包裝設計',short:'MTB 車把手包裝設計',desc:'MTB 車把手三層瓦楞結構包裝，考量層板方案、正面紙板與包裝底座。',tags:['包裝設計','自行車','Handle Bar'], images: ['/assets_img/images/mtb_handle_bar01.jpg', '/assets_img/images/mtb_handle_bar02.jpg', '/assets_img/images/mtb_handle_bar03.jpg', '/assets_img/images/mtb_handle_bar04.png', '/assets_img/images/mtb_handle_bar05.png', '/assets_img/images/mtb_handle_bar06.png']},
  {id:'tr',cat:'packaging',subcat:'bike',title:'TR Handle Bar 包裝設計',short:'TR 車把手包裝設計',desc:'TR Handle Bar 包裝結構設計，統整行李方案、正面紙板至包裝底座完整流程。',tags:['包裝設計','自行車'], images: ['/assets_img/images/tr_handle_bar01.jpg', '/assets_img/images/tr_handle_bar02.jpg', '/assets_img/images/tr_handle_bar03.jpg', '/assets_img/images/tr_handle_bar04.jpg', '/assets_img/images/tr_handle_bar05.jpg', '/assets_img/images/tr_handle_bar06.png', '/assets_img/images/tr_handle_bar07.png', '/assets_img/images/tr_handle_bar08.png']},
  {id:'ra',cat:'packaging',subcat:'bike',title:'RA Handle Bar 包裝設計',short:'RA 車把手包裝設計',desc:'RA Handle Bar 系列包裝設計，涵蓋運輸、展示與量產導入規格。',tags:['包裝設計','自行車'], images: ['/assets_img/images/ra_handle_bar01.png', '/assets_img/images/ra_handle_bar02.png', '/assets_img/images/ra_handle_bar03.png', '/assets_img/images/ra_handle_bar04.png', '/assets_img/images/ra_handle_bar05.png', '/assets_img/images/ra_handle_bar06.png', '/assets_img/images/ra_handle_bar07.png']},
  {id:'seatpost',cat:'packaging',subcat:'bike',title:'座管 包裝設計',short:'座管包裝結構設計',desc:'自行車座管包裝結構設計，針對細長零件開發全紙質緩衝方案。',tags:['包裝設計','自行車','減塑'], images: ['/assets_img/images/seatpost01.jpg', '/assets_img/images/seatpost02.jpg', '/assets_img/images/seatpost03.jpg', '/assets_img/images/seatpost04.jpg', '/assets_img/images/seatpost05.jpg', '/assets_img/images/seatpost06.jpg', '/assets_img/images/seatpost07.jpg', '/assets_img/images/seatpost08.jpg', '/assets_img/images/seatpost09.jpg']},
  {id:'steerer',cat:'packaging',subcat:'bike',title:'立管 包裝設計',short:'立管包裝結構設計',desc:'立管包裝設計，開發輕量化、可回收包材方案。',tags:['包裝設計','自行車'], images: ['/assets_img/images/steerer01.jpg', '/assets_img/images/steerer02.jpg', '/assets_img/images/steerer03.jpg', '/assets_img/images/steerer04.jpg', '/assets_img/images/steerer05.jpg']},
  {id:'quickrelease',cat:'packaging',subcat:'bike',title:'快拆束仔 包裝設計',short:'快拆束仔包裝設計',desc:'快拆束仔小零件包裝設計，兼顧防護性與零售展示需求。',tags:['包裝設計','自行車'], images: ['/assets_img/images/quickrelease01.jpg', '/assets_img/images/quickrelease02.jpg', '/assets_img/images/quickrelease03.jpg', '/assets_img/images/quickrelease04.jpg']},
  {id:'graphic',cat:'graphic',subcat:'branding',title:'平面設計',short:'品牌CIS / 海報 / 識別物料',desc:'品牌視覺識別系統（CIS）、海報設計與企業識別物料整合輸出。',tags:['品牌設計','平面','CIS'], images: ['/assets_img/images/poster_design.jpg']}
];
...
const COURSES = [
  {
    ...
    images: ['/assets_img/images/course-packaging.png', '/assets_img/images/course-packaging-photo.jpg']
  },
  {
    cat: 'ai', 
    ...
    images: ['/assets_img/images/course-ai-talent.png']
  },
  {
    cat: 'ai', 
    ...
    images: ['/assets_img/images/ipas-ai-planning-cert.jpg']
  },
  {
    cat: 'ai', 
    ...
    images: ['/assets_img/images/chat-gpt-lv1.jpg', '/assets_img/images/make-lv1.jpg', '/assets_img/images/nuva-group-photo.jpg']
  },
  {
    cat: 'ai', 
    ...
    images: ['/assets_img/images/ipas-ai-planning-basic.jpg']
  }
];
...
const EXP_DATA = [
  ...
  },
  {
    ...
    logo: '/assets_img/images/sakura-logo.png',
  ...
  },
  {
    ...
    logo: '/assets_img/images/emg-logo.png',
  ...
  },
  {
    ...
    logo: '/assets_img/images/cic-logo.png',
...
const INTERESTS = [
  { id: 'gym', title: '重量訓練', icon: Dumbbell, goal: '目前每週2練，\n目標提升至每週4練！', desc: '訓練耐力與自律，堅持每一步小進步，挑戰更強的自己。', emojis: ['🏋️', '💪', '🏃', '⚡'], image: '/assets_img/images/gym.jpg' },
  { id: 'marathon', title: '馬拉松', icon: Timer, goal: '5次半馬，\n目標完成人生第一場全馬！', desc: '目前有5次半馬的經驗，目標挑戰人生第一場全馬拉松，不只是體能，更是堅持信念的挑戰！', emojis: ['🏅', '🎽', '🏃‍♀️', '🥇'], image: '/assets_img/images/marathon.jpg' },
  { id: 'hiking', title: '登山', icon: Mountain, goal: '登頂2座百岳，\n目標持續挑戰台灣百岳全集！', desc: '除了健身與長跑，我也熱愛登山挑戰，目前已成功攀登兩座台灣百岳。', emojis: ['⛰️', '🌄', '🥾', '🗻'], image: '/assets_img/images/hiking.jpg' }
];
...
const AvatarSVG = () => (
  <img 
    src="/assets_img/images/profile.jpg" 
    alt="賴以婕 Amanda" 
      ...
      <div className="border-2 border-[#e9ecef] bg-white rounded-xl p-5 transition-all hover:border-[#3d7a5a] mt-8">
        ...
        <div className="space-y-4">
          <div className="flex gap-3 items-center">
            <div className="w-10 flex justify-center shrink-0">
              <div className="w-10 h-10 rounded-lg bg-white border border-[#e9ecef] shrink-0 flex items-center justify-center overflow-hidden relative group">
                <img src="/assets_img/images/ntust-logo.png" alt="國立臺灣科技大學" className="w-full h-full object-contain p-1" referrerPolicy="no-referrer" />
              </div>
            </div>
            <div>
          ...
          <div className="flex gap-3 items-center">
            <div className="w-10 flex justify-center shrink-0">
              <div className="w-10 h-10 rounded-lg bg-white border border-[#e9ecef] shrink-0 flex items-center justify-center overflow-hidden relative group">
                <img src="/assets_img/images/tcivs-logo.jpg" alt="國立台中高工" className="w-full h-full object-contain p-1" referrerPolicy="no-referrer" />
              </div>
            </div>
            <div>
        ...
        <div className="mt-8 pt-6 border-t border-[#e9ecef]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8 pl-[52px]">
            {[
              ...
              { name: 'AutoCAD', logo: '/assets_img/images/autocad-logo-1.jpg' }
            ].map((t, i) => (
