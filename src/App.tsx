      ...
      <div className="border-2 border-[#e9ecef] bg-white rounded-xl p-5 transition-all hover:border-[#3d7a5a] mt-8">
        ...
        <div className="space-y-4">
          <div className="flex gap-3 items-center">
            <div className="w-10 flex justify-center shrink-0">
              <div className="w-10 h-10 rounded-lg bg-white border border-[#e9ecef] shrink-0 flex items-center justify-center overflow-hidden relative group">
                <img src='./images/ntust-logo.png' alt="國立臺灣科技大學" className="w-full h-full object-contain p-1" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              </div>
            </div>
            <div>
          ...
          <div className="flex gap-3 items-center">
            <div className="w-10 flex justify-center shrink-0">
              <div className="w-10 h-10 rounded-lg bg-white border border-[#e9ecef] shrink-0 flex items-center justify-center overflow-hidden relative group">
                <img src='./images/tcivs-logo.jpg' alt="國立台中高工" className="w-full h-full object-contain p-1" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              </div>
            </div>
            <div>
